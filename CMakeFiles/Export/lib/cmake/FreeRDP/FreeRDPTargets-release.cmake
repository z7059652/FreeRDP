...
set_target_properties(freerdp PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/freerdp.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "ws2_32;C:/OpenSSL-Win64/lib/VC/ssleay32MD.lib;C:/OpenSSL-Win64/lib/VC/libeay32MD.lib;winpr"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp.dll"
  )
...
set_target_properties(audin-client PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/audin-client.lib"
  )
...
# Import target "audin-client-winmm" for configuration "Release"
set_property(TARGET audin-client-winmm APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(audin-client-winmm PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "freerdp;winmm.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/audin-client-winmm.lib"
  )
...
set_target_properties(cliprdr-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/cliprdr-client.lib"
  )
...
set_target_properties(disp-client PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/disp-client.lib"
  )
...
set_target_properties(drdynvc-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/drdynvc-client.lib"
  )
...
set_target_properties(drive-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/drive-client.lib"
  )
...
set_target_properties(echo-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/echo-client.lib"
  )
...
set_target_properties(encomsp-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/encomsp-client.lib"
  )
...
# Import target "printer-client" for configuration "Release"
set_property(TARGET printer-client APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(printer-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/printer-client.lib"
  )
...
set_target_properties(rail-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/rail-client.lib"
  )
...
set_target_properties(rdpdr-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/rdpdr-client.lib"
  )
...
set_target_properties(rdpei-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/rdpei-client.lib"
  )
...
set_target_properties(rdpgfx-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/rdpgfx-client.lib"
  )
...
set_target_properties(rdpsnd-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/rdpsnd-client.lib"
  )
...
# Import target "rdpsnd-client-winmm" for configuration "Release"
set_property(TARGET rdpsnd-client-winmm APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(rdpsnd-client-winmm PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;winmm.lib;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/rdpsnd-client-winmm.lib"
  )
...
set_target_properties(remdesk-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/remdesk-client.lib"
  )
...
set_target_properties(smartcard-client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp/smartcard-client.lib"
  )
...
set_target_properties(freerdp-client PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/freerdp-client.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/freerdp-client.dll"
  )
...
# Import target "wfreerdp-client" for configuration "Release"
set_property(TARGET wfreerdp-client APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(wfreerdp-client PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/wfreerdp-client.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "freerdp-client;winpr;freerdp"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/wfreerdp-client.dll"
  )
